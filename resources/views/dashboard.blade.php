            ...
            <div class="bg-white-800  rounded font-medium text-gray-800 shadow  hover:bg-blue-700 hover:text-white"> 
                    <div x-data="{ dropdownOpen: false }" class="relative">
                        ...
                        <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                              <div class="inline">
                                <a href="{{route('contact.show', $contact->id)}}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white ">
                              ...
                              <form action="{{route('dashboard.destroy', $contact->id)}}" method="POST" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white ">
                                @csrf
                                @method('DELETE')
